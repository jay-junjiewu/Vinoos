...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'We are based in Umm Al Quwain, UAE, and deliver projects across the UAE and the wider GCC, including Dubai, Abu Dhabi, Saudi Arabia and Oman.',
  },
  {
  ...
  {
    question: 'How long has Vinoos Trading been in business?',
    answer:
